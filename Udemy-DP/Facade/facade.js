// Facade gives us an easy way to
// understand and use an interface
// over a large block of code
...
const squareGenerator = new MagicSquareGenerator();
console.log(squareGenerator.generate(3));